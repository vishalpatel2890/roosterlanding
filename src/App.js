				...
				<Parallax strength={this.state.SCREEN_HEIGHT}>
					<Background>
						<img
							...
							style={{ width: this.state.SCREEN_WIDTH, height: SCREEN_HEIGHT }}
						/>
					</Background>
					<br />
							...
							<div className="left-column">
								...
								<div className="wrap">
									<p>
										...
										ultricies ex urna, vel porttitor arcu commodo id.
										Suspendisse eget felis congue, aliquet velit ut, lacinia
										risus. Quisque ac nisl at nunc fringilla hendrerit quis sed
										justo. Curabitur urna eros, iaculis in lacinia quis,
								...
								>
									...
									<Row>
										<TextField
											...
											onChange={e =>
												this.handleTextFieldChange(e, textFieldFirstNameValue)}
										/>
										<TextField
											hintText="Last Name"
											style={{
